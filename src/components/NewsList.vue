...
.news-list__empty {
  ...
  border: 1px dashed var(--accent-cyan-alpha-30);
...
.news-list__button:focus {
  ...
  border-color: var(--accent-cyan-alpha-80);
...
.news-list__button:focus {
  outline: none;
  box-shadow: 0 0 25px var(--accent-cyan-alpha-30), 0 0 0 3px var(--accent-cyan-alpha-20);
}
